 ...
 *
 * An instance of this class is the raw input used by the {@link JPSXClassLoader} to construct a new machine,
 * however instances of this class may be built from another source (e.g. {@link XMLMachineDefinitionParser})<p>
 *
 * In addition to defining the components, the machine definition also includes the class name prefixes that the {@link JPSXClassLoader}
 * should consider to be part of machine runtime. All runtime classes should be loaded by the {@link JPSXClassLoader} instead of the
