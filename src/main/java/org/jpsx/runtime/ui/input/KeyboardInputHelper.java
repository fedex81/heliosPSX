...
public class KeyboardInputHelper {
    ...
    public static final Map<String, Integer> DEFAULT_P1_KEY_BINDINGS = ImmutableMap.<String, Integer>builder().
            ...
            put(L.name(), VK_LEFT).
            put(R.name(), VK_RIGHT).
            put(TRIANGLE.name(), VK_I).
            put(SQUARE.name(), VK_J).
            put(CROSS.name(), VK_K).
            put(CIRCLE.name(), VK_L).
            put(L1.name(), VK_G).
            put(L2.name(), VK_B).
            put(R1.name(), VK_H).
            put(R2.name(), VK_N).
            put(SELECT.name(), VK_SPACE).
...
//            put(M.name(), VK_N).
    ...
    private static final Logger LOG = Logger.getLogger(KeyboardInputHelper.class.getSimpleName());
