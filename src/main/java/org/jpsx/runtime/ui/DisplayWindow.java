...
//        @Override
//        public void renderScreenLinear(int[] data, Optional<String> label, SystemProvider.VideoMode videoMode) {
//
//        }
...
//    void renderScreenLinear(int[] data, Optional<String> label, SystemProvider.VideoMode videoMode);
